...
?>
        ...
        <div class="card-body">
          <div style="color: white; font-size: 20px;">  Atualize sua data de nascimento </div>
            <div class="input-group form-group">
                    <div class="input-group-prepend">
                        <span class="input-group-text"><i class="fas fa-user"></i></span>
                    </div>
                
                    <form action="adddata_nasc.php" method="POST">
                    <input name="data_nasc" type="date"  class="form-control"    autocomplete="off" required>
                </div>
