...
<link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css'><link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/dialog-polyfill/0.4.2/dialog-polyfill.min.css'><link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/material-design-lite/1.2.1/material.min.css'><link rel='stylesheet prefetch' href='https://code.getmdl.io/1.2.1/material.blue-light_blue.min.css'>
    ...
    <header>                           
                    <div class="row">
                            ...
                            <h2>Editar a Quantidade de Folga<h2>
                          <div>
                            <li>
                                    </li>
</div>
...
<?php
                          ...
                          include_once('../conexoes/conect.php');
                           $sql = "SELECT * FROM previsao WHERE motivo LIKE '%fOLGA%' ORDER by id_previsao ASC";
                ...
                <table class="mdl-data-table mdl-js-data-table mdl-cell mdl-cell--12-col">
                    ...
                    <tbody>
                        ...
                        while($user_data = mysqli_fetch_assoc($result)){
                            ...
                            if($user_data['qtd_prevista'] == '1'){
                                echo "<td>".$user_data['qtd_prevista']." = 24H</td>";
                            }
                            if($user_data['qtd_prevista'] == '2'){
                                echo "<td>".$user_data['qtd_prevista']." = 48H</td>";
                            }
                            if($user_data['qtd_prevista'] == '3'){
                                echo "<td>".$user_data['qtd_prevista']." = 72H</td>";
                            }
                            if($user_data['qtd_prevista'] == '4'){
                                echo "<td>".$user_data['qtd_prevista']." = 96H</td>";
                            }
                            if($user_data['qtd_prevista'] == '5'){
                                echo "<td>".$user_data['qtd_prevista']." = 120H</td>";
                            }
                            if($user_data['qtd_prevista'] == '6'){
                                echo "<td>".$user_data['qtd_prevista']." = 144H</td>";
                            }
                            if($user_data['qtd_prevista'] == '7'){
                                echo "<td>".$user_data['qtd_prevista']." = 168H</td>";
                            }
                            if($user_data['qtd_prevista'] == '8'){
                                echo "<td>".$user_data['qtd_prevista']." = 192H</td>";
                            }
                            if($user_data['qtd_prevista'] == '9'){
                                echo "<td>".$user_data['qtd_prevista']." = 216H</td>";
                            }
                            if($user_data['qtd_prevista'] == '10'){
                                echo "<td>".$user_data['qtd_prevista']." = 240H</td>";
                            }
                           
                            
                            echo "<td>
                            <a class='btn btn-sm btn-primary' href='editarfolga.php?id=$user_data[id_previsao]'>
