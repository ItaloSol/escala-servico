...
<?php
                          ...
                          include_once('../conexoes/conect.php');
                           $sql = "SELECT * FROM previsao WHERE motivo LIKE '%sobreaviso%' ORDER by id_previsao ASC";
                ...
                <table class="mdl-data-table mdl-js-data-table mdl-cell mdl-cell--12-col">
                    ...
                    <tbody>
                        ...
                        while($user_data = mysqli_fetch_assoc($result)){
                           ...
                           $exprodir = $user_data['qtd_prevista'];
                           $arrayexplodido = explode("0",$exprodir); 
                           
                           foreach($arrayexplodido as $key ){
                            echo "<td>".$key." </td>";
                           }
                            ...
                            echo "<td>
                            <a class='btn btn-sm btn-primary' href='editarsobre.php?id=$user_data[id_previsao]'>
