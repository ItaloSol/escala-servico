...
<?php
                          ...
                          if(isset($_GET['l'])){
                            ...
                            $sql = "SELECT * FROM militares m INNER JOIN graduacoes g ON g.id_graduacao = m.graduacao ORDER by m.nome_de_guerra ASC";
                            $result = $conect->query($sql);
                          }
                ...
                <table class="mdl-data-table mdl-js-data-table mdl-cell mdl-cell--12-col">
                    ...
                    <tbody>
                        ...
                        while($user_data = mysqli_fetch_assoc($result)){
                            ...
                            echo "<td>
                            <a  href='../militar/proc_licenciar_usuario.php?id=" . $user_data['id'] . "'  class='btn btn-sm btn-primary' >
