...
<link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/normalize/5.0.0/normalize.min.css'><link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/dialog-polyfill/0.4.2/dialog-polyfill.min.css'><link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/material-design-lite/1.2.1/material.min.css'><link rel='stylesheet prefetch' href='https://code.getmdl.io/1.2.1/material.blue-light_blue.min.css'>
    ...
    <header>                           
	<title>Trocar Banco de Dados</title>	   <div class="row">
...
<?php
    ...
    <div class="mdl-ce11">
		...
		<form  style="margin-left: 5%; margin-top: 2%;" method="POST" action="troca_bd.php">
		 <div style="font-size: 20px;" >Qual Banco de Dados Usar?</div>		
		 <input type="radio" id="bd1" name="banco" value="bd1" required>
		 <label for="bd1">Bando de Dados Oficial</label>
         <br>
         <input type="radio" id="bd2" name="banco" value="bd2" required>
         <label for="bd2">Banco de Dados Para Testes</label>
         <br>
         <input type="radio" id="bd3" name="banco" value="bd3" required>
         <label for="bd3">Banco de Dados Para Local</label>
