    ...
    <header>                           
                    <div class="row">
                                ...
                                <div class="search hidden-xs hidden-sm">
                                    ...
                                    <a href="historicodeatividade.php">   <b>Logins</b>
                ...
                unset($_SESSION['msg']);
                                    ...
                                    --    INNER JOIN militares m ON a.fk_usuario = m.id 
                                       ...
                                       $query_data_ultimo_sv = $conexao->prepare("SELECT * FROM atividade a 
                                        INNER JOIN descricao_de_atividade d ON a.fk_alteracao = d.id_descricao 
                                        INNER JOIN militares m ON a.fk_usuario = m.id INNER JOIN graduacoes g ON g.id_graduacao = m.graduacao  WHERE a.fk_alteracao = '27'
                                       ORDER BY a.id_atividade DESC LIMIT 1000");//SELECIONA A TABELA DE MILITARES
                ...
                <main class="">
                    ...
                    <div class="mdl-grid">
                        ...
                        $sql_dados = $conexao->prepare("SELECT * FROM atividade WHERE fk_alteracao = '27'");
                           ...
                           $total = count($Conta);
                            echo 'Quantidade de Logins registrados: '.  round($total); ?>
