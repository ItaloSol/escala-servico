        ...
        <?php /* SISTEMA DE ESCALA DE SERVIÇO CRIADO POR SD ÍTALO SOL SCLOCOO *DANTAS*  */  include_once('../dados/postos.php');  ?>                       
                    <div class="row">
                                ...
                                <div class="search hidden-xs hidden-sm">
                                    ...
                                    <li>
                                    <a href="impedimento.php" class="icon-info"><button class="btn btn-dblue btn-lg" role="button" class="submit">Voltar</button></a>
                                    </li>

                            <h2>Escolha Os militres para adicionar o Impedimento<h2>
                                <form method="POST" action="saveimped.php">
                                <b > Selecionar o Motivo </b>
            <select name="motivo">
            ...
            $cont = 0;
                   ...
                   echo '<option name="motivo" value="MISSÃO" >Missão</option>';
                   echo '<option name="motivo" value="ATESTADO" >Atestado</option>';
                   echo '<option name="motivo" value="FERIAS" >Ferias</option>';
                   echo '<option name="motivo" value="DISPENSA" >Dispensa</option>';
                
                ?>
         </select>
								</select>
                                <br>
                                <input type="text" name="oumotivo" id="motivo" placeholder="Outros Motivos">          
         ...
         <input type="RADIO" id="AMBAS" value="AMBAS" name="tiposv"  required> <label for="AMBAS">AMBAS</label>
...
if(isset($_SESSION['msg'])){
    ...
    unset($_SESSION['msg']);
                           ...
                           $sql = "SELECT * FROM militares m INNER JOIN graduacoes g ON g.id_graduacao = m.graduacao  WHERE m.servico != 'LICENCIADO' ORDER by  m.antiguidade DESC";
