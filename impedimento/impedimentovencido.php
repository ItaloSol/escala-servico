...
<?php /* SISTEMA DE ESCALA DE SERVIÇO CRIADO POR SD ÍTALO SOL SCLOCOO *DANTAS*  */ include_once('../gerenciamento/menunotifica.php');?>
	...
	<div class="row">
    <div class="direita">
    <b>Impedimento Vencido</b>
   <a href="impedimento.php">
            ...
            <div class="panel panel-default panel-table">
              ...
              <div class="panel-body">
                ...
                <?php
                           ...
                           $sql = "SELECT * FROM impedimentos i INNER JOIN militares m ON i.fk_militares = m.id INNER JOIN graduacoes g ON g.id_graduacao = m.graduacao  WHERE i.vencimento = 'VENCIDO' ORDER BY  i.data_final DESC";
...
?>
    ...
    <form action="saveimped.php" method="POST">
      <div id="add_project" class="modal fade" role="dialog">
        ...
        <input type="text" style="text-transform:uppercase" name="nome_de_guerra" id="nome_de_guerra" placeholder="Pesquisar pelo Nome">
