  ...
  <div class="modal  " >
    ...
    <form action="definicao.php" method="POST">
      ...
      while ($x < $Id_Escalados) {
          ...
          echo '<input type="text" style="text-transform:uppercase" value="'.$Escalado_Prev_Nome[$x].'" name="usuario' . $Numero_Contagem[$x] . '"  id="usuario' . $Numero_Contagem[$x] . '" placeholder="Pesquisar usuário" onkeyup="listar_usuariosTodos(this.value, this.id)" />';
          echo '<span id="resultado_pesquisa_usuario'.$Numero_Contagem[$x]. '"></span>';
    ...
    <div class="modal" style="z-index: 1;">
      ...
      <form action="definicao.php" method="POST">
        ...
        while ($x < $Total_De_Militares_Escalados) {
            ...
            echo '<input type="text" style="text-transform:uppercase" value="'.$Definido_Prev_Nome[$x].'" name="usuario' . $Numero_Contagem[$x] . '"  id="usuario' . $Numero_Contagem[$x] . '" placeholder="Pesquisar usuário" onkeyup="listar_usuariosTodos(this.value, this.id)" />';
            echo '<span id="resultado_pesquisa_usuario'.$Numero_Contagem[$x]. '"></span>';
