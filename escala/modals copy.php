...
if ($Escala == false) {
  ...
  <div class="row">
    ...
    <div class="col-6"><div style="left:55%;" class="abrir btn btn-danger" >Definir data de servico</div></div>
    
    
  </div>
  <!-- <div onclick="acao()" class="btn">Definir Serviço Do Militar</div> !-->

  <div style=" display: flex; align-items: center; justify-content: center;" class="modal ">
  
    
    <?php
    if(!isset($Escalados_Id)){
      //echo '<div  onclick="fecharmodal()" style="width: 115px; height: 98px; font-size: 50px; display: flex; align-items: center; justify-content: center;" class="fechar">NÃO</div>';
      echo '<p style="font-size: 30px;" >Definir essa data sem nenhum militar?</p>';
      echo '<a href="definicao.php?dt='.$Data_Selecionada.'" style="width: 115px; height: 98px; font-size: 50px; display: flex; align-items: center; justify-content: center; background-color: yellow; border-radius: 50%;">Sim</a>';
    } else {
      echo '<div  onclick="fecharmodal()" class="fechar">X</div>';
...
<?php /* SISTEMA DE ESCALA DE SERVIÇO CRIADO POR SD ÍTALO SOL SCLOCOO *DANTAS*  */if ($Escala == true) { ?>
    <div class="row">
      <div style="left:25%; " class="abrir btn btn-danger">Troca de servico</div>
    </div>
    <!-- <div onclick="acao()" class="btn">Definir Serviço Do Militar</div> !-->
