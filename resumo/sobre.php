            ...
            <div style="position:fixed;" class="col-md-2 col-sm-0 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="../resumo/sobre.php"><i class="fa fa-info " aria-hidden="true"></i><span class="hidden-xs hidden-sm">Sobre</span></a></li>
...
<body style="background-size: cover; background-image: url(../img/camuflado.jpg); backdrop-filter: blur(5px);" >
    ...
    <hr style="clear: both; height:10px;">
    <div>
        <h3 style="text-align: center; color: white; clear:both;">Sistema Desenvolvido por: </h3>
        <h4 style="text-align: center; color: white; clear:both;">Ítalo Sol Sclocco Dantas </h4>
    </div>

    <hr>
   <h5 style="text-align: center; color: white; clear:both;">Dúvidas sobre o sistema, Reportar Bugs ou Elogios <br> entre em contato com <br> <a href="https://criarmeulink.com.br/u/1673895915">italo.sol100@gmail.com</a></h5>
</body>
<script>
    new PureCounter();
</script>
