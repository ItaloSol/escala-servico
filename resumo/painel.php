...
<body style="background-size: cover; background-image: url(../img/camuflado.jpg); backdrop-filter: blur(5px);" >

    <div>
        <i>

            <div style=" text-align: center; float:left;" class="col-md-1 col-xl-3">
            <div  style=" background-size: cover; background-image: url(../img/camuflado2.jpg);  " class="card bg-secondary text-white mb-3">
                    <div class="card-header" style="background-color: black; color:white;">
                        <img src="data:image/png;base64,"><strong>Escala Interna</strong>
                    </div>
...
background: linear-gradient(180deg, rgba(0,0,0,1) 50%, rgba(255,0,0,0.7203256302521008) 100%); color:white;" class="card-body">
            ...
            <div style="text-align: center; float:left;" class="col-md-1 col-xl-3">
                <div  style=" background-size: cover; background-image: url(../img/camuflado2.jpg);  " class="card bg-secondary text-white mb-3">
                    <div class="card-header" style="background-color: black; color:white;">
                        <img src="data:image/png;base64,"><strong>Externa Gerida Pela OM</strong>
                    </div>
                    <div style="background: rgb(0,0,0);
background: linear-gradient(180deg, rgba(0,0,0,1) 50%, rgba(255,0,0,0.7203256302521008) 100%); color:white;" class="card-body">
            ...
            <div style="text-align: center; float:left;" class="col-md-1 col-xl-3">
                <div  style=" background-size: cover; background-image: url(../img/camuflado2.jpg);  " class="card bg-secondary text-white mb-3">
                    <div class="card-header" style="background-color: black; color:white;">
                        <img src="data:image/png;base64,"><strong>Escala Missão</strong>
                    </div>
                    <div style="background: rgb(0,0,0);
background: linear-gradient(180deg, rgba(0,0,0,1) 50%, rgba(255,0,0,0.7203256302521008) 100%); color:white;" class="card-body">
...
background: linear-gradient(180deg, rgba(0,0,0,1) 50%, rgba(255,0,0,0.7203256302521008) 100%); color:white;">
                        ...
                        <img src="data:image/png;base64,"><strong>Não Gerida Pela OM</strong>
