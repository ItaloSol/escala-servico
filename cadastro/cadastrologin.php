        ...
        <div class="card-body">
          ...
          <input type="hidden" name="id_usuario0"  id="id_usuario0" required>
               ...
               <div class="input-group form-group">
                    ...
                    <input name="email" type="number"  class="form-control" placeholder="Identidade Militar"  min="1000000000" max="9999999999" autocomplete="off" required>
                </div>
                <div class="input-group form-group">
                    <div class="input-group-prepend">
                ...
                <div class="input-group form-group">
                    ...
                    <input  name="senha1" type="password" class="form-control" placeholder="Confirmar Senha" required>
                </div>
